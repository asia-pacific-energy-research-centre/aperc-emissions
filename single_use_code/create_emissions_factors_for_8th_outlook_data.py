...
mapping_sheet = "outlook_8th"

emission_factors_sheet ="IPCC Emission Factors 2021"

output_sheet = "outlook_8th_emissions_factors.csv"
#%%
#LOAD
...
IPCC_carbon_content = IPCC_carbon_content[["fuel_code", "IPCC_emission_factors_2021_fuel", "Default Carbon content(kg/GJ)"]]
...
#set index
IPCC_carbon_content= IPCC_carbon_content.set_index(['fuel_code'])
