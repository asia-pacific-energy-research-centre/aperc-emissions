...
#%%
#improt the data
energy_ref = pd.read_excel('single_use_inputs/00_APEC_reference_results_2022-05-16-153419.xlsx', sheet_name='UseByTechnology')
energy_cn = pd.read_excel('single_use_inputs/00_APEC_net-zero_results_2022-05-16-153553.xlsx', sheet_name='UseByTechnology')
...
power_sector_emissions = power_sector.groupby(['Economy', 'Year', 'Scenario'])['Emissions', 'Value'].mean().reset_index()
